...
/**
 * A utility class to aid in the conversion of character arrays to byte arrays
 * and vice versa. It is designed to be used by the {@link PasswordUtility}
 * class, but could be used in other places as well.
 * 
