...
class CollectionRemoveElementVerifier extends MutualRegistrationVerifier
{

	private static final Logger logger = LoggerFactory.getLogger(CollectionRemoveElementVerifier.class);

	CollectionRemoveElementVerifier(TestContext context, ITypeFactory typeFactory)
	{
	...
	public void verify()
	{
		...
		Method removeFromCollection = getContextMethod(Operation.COLLECTION_REMOVE);
		...
		try
		{
			...
			removeFromCollection.invoke(system, arguments);
