...
import static name.reynolds.vineet.verifier.registration.context.CollectionTestType.*;
import static name.reynolds.vineet.verifier.registration.context.PropertyTestType.*;
import static name.reynolds.vineet.verifier.registration.context.RelationType.*;

import java.util.*;

import name.reynolds.vineet.verifier.registration.context.*;
