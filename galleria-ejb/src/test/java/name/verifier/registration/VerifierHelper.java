...
import static name.verifier.registration.context.CollectionTestType.*;
import static name.verifier.registration.context.PropertyTestType.*;
import static name.verifier.registration.context.RelationType.*;

import java.util.*;
import name.verifier.registration.context.CollectionTestType;
import name.verifier.registration.context.PropertyTestType;
import name.verifier.registration.context.RelationType;
