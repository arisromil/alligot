...
public class PasswordUtilityTest
{
	...
	public void testCreatePasswordDigestSingleLATINChar() throws Exception
	{
		char[] password = { 'Ö' };
		char[] digest = PasswordUtility.getDigest(password, "SHA-512");
		char[] expectedDigest = "874541ccab596c7f5a09b15acb9d02bd739d665d2223890f604dd6e7f0e66d3e9d79ed835626d9f6648938e8b7fae89382d560065863b935f4f234ac9a23fa0c"
				.toCharArray();
		assertArrayEquals(expectedDigest, digest);
	}
	...
	public void testCreatePasswordDigestMultipleLATINChar() throws Exception
	{
		...
		char[] digest = PasswordUtility.getDigest(password, "SHA-512");
		char[] expectedDigest = "5b091b98937cdd36cf4476729fd37f79b6714a960e75c9ec31cc1231b9a0830a4f3dbe42a3a8bcea83957e9b11d1bd2652f6197756a1c63b357940cc3cc92803"
				.toCharArray();
		assertArrayEquals(expectedDigest, digest);
	}
	...
	public void testCreatePasswordDigestOfInvalidUTF16Sequence() throws Exception
	{
