...
public class PrimitiveArrayConverterTest
{
	...
	{
		char[] input = {};
		byte[] bytes = PrimitiveArrayConverter.convertCharArrayToBytes(input, UTF_8);
		assertNotNull(bytes);
		byte[] expectedBytes = {};
	...
	public void testConvertTwoUTF16BECharsToBytes() throws Exception
	{
		...
		// BOM
		byte[] bytes = PrimitiveArrayConverter.convertCharArrayToBytes(input, UTF_16BE);
		assertNotNull(bytes);
	...
	public void testConvertTwoUTF16LECharsToBytes() throws Exception
	{
		...
		// BOM
		byte[] bytes = PrimitiveArrayConverter.convertCharArrayToBytes(input, UTF_16LE);
		assertNotNull(bytes);
	...
	public void testConvertOneUTF16CharToBytes() throws Exception
	{
		...
		// Specify UTF-16LE as the encoding, otherwise the output will contain a
		// BOM
		byte[] bytes = PrimitiveArrayConverter.convertCharArrayToBytes(input, UTF_16);
		assertNotNull(bytes);
		byte[] expectedBytes = { DECIMAL_0XFE, DECIMAL_0XFF, DECIMAL_0, DECIMAL_97 };
		assertArrayEquals(expectedBytes, bytes);
	}
	...
	public void testConvertTwoUTF16CharsToBytes() throws Exception
	{
		...
		byte[] bytes = PrimitiveArrayConverter.convertCharArrayToBytes(input, UTF_16);
		assertNotNull(bytes);
		byte[] expectedBytes = { DECIMAL_0XFE, DECIMAL_0XFF, DECIMAL_0, DECIMAL_97, DECIMAL_0, DECIMAL_98 };
		assertArrayEquals(expectedBytes, bytes);
	}
	...
	{
		byte[] input = {};
		char[] chars = PrimitiveArrayConverter.convertByteArrayToChars(input, UTF_8);
		assertNotNull(chars);
		char[] expectedChars = {};
	...
	public void testConvertTwoUTF16BEBytesToChars() throws Exception
	{
		...
		// Specify UTF-16BE as the encoding, otherwise the output will contain a
		// BOM
		char[] chars = PrimitiveArrayConverter.convertByteArrayToChars(input, UTF_16BE);
		assertNotNull(chars);
		char[] expectedChars = { LATIN_SMALL_LETTER_A };
		assertArrayEquals(expectedChars, chars);
	}
	...
	public void testConvertTwoUTF16LEBytesToChars() throws Exception
	{
		...
		// Specify UTF-16LE as the encoding, otherwise the output will contain a
		// BOM
		char[] chars = PrimitiveArrayConverter.convertByteArrayToChars(input, UTF_16LE);
		assertNotNull(chars);
		char[] expectedChars = { LATIN_SMALL_LETTER_A };
		assertArrayEquals(expectedChars, chars);
	}
	...
	public void testConvertOneUTF16ByteToChars() throws Exception
	{
		...
		// Specify UTF-16LE as the encoding, otherwise the output will contain a
		// BOM
		char[] chars = PrimitiveArrayConverter.convertByteArrayToChars(input, UTF_16);
		assertNotNull(chars);
		char[] expectedChars = { LATIN_SMALL_LETTER_A };
		assertArrayEquals(expectedChars, chars);
	}
	...
	{
		byte[] input = { DECIMAL_0XFE, DECIMAL_0XFF, DECIMAL_0, DECIMAL_97, DECIMAL_0, DECIMAL_98 };
		char[] chars = PrimitiveArrayConverter.convertByteArrayToChars(input, UTF_16);
		assertNotNull(chars);
		char[] expectedChars = { LATIN_SMALL_LETTER_A, LATIN_SMALL_LETTER_B };
		assertArrayEquals(expectedChars, chars);
